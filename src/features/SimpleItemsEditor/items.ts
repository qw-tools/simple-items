...
const GreenArmor: Item = {
  ...
  ...toSettings("simple_armor_0.png", "#00cc00"),
};
const YellowArmor: Item = {
  name: "Yellow Armor",
  filename: "simple_armor_1.png",
  textureDirPath: modelsDirPath,
  ...toSettings("simple_armor_1.png", "#ffff00"),
};
const RedArmor: Item = {
  name: "Red Armor",
  filename: "simple_armor_2.png",
  textureDirPath: modelsDirPath,
  ...toSettings("simple_armor_2.png", "#ff0000"),
};
...
const Quad: Item = {
  ...
  textureDirPath: modelsDirPath,
  ...toSettings("simple_quaddama_0.png", "#0099ff"),
};
const Pent: Item = {
  name: "Pent",
  filename: "simple_invulner_0.png",
  textureDirPath: modelsDirPath,
  ...toSettings("simple_invulner_0.png", "#ff0000"),
};
const Ring: Item = {
  name: "Ring",
  filename: "simple_invisibl_0.png",
  textureDirPath: modelsDirPath,
  ...toSettings("simple_invisibl_0.png", "#ffff00"),
};
...
const MegaHealth: Item = {
  ...
  ...toSettings("simple_b_bh100_0.png", "#66ddee"),
};
const HealthLarge: Item = {
  name: "Large health",
  filename: "simple_b_bh25_0.png",
  textureDirPath: bmodelsDirPath,
  ...toSettings("simple_b_bh25_0.png", "#eeee00"),
};
const HealthSmall: Item = {
  name: "Small health",
  filename: "simple_b_bh10_0.png",
  textureDirPath: bmodelsDirPath,
  ...toSettings("simple_b_bh10_0.png", "#33ff33"),
};
